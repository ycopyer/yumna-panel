...
const { sendNotification } = require('../services/notification'); // To be migrated
const ComplianceService = require('../services/compliance'); // To be migrated
const PushService = require('../services/pushNotification'); // To be migrated

// Mock services for now to allow logger to run without errors
// const sendNotification = (msg) => console.log('[MOCK NOTIFICATION]', msg);
// const ComplianceService = { logSecureActivity: async () => ({ eventId: 'mock-id' }) };
// const PushService = { sendToUser: async () => { } };
