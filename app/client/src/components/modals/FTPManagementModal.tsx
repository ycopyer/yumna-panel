...
import { X, Key, Trash2, Loader2, Save, Eye, EyeOff, FolderOpen, Activity, Lock, Unlock, HardDrive } from 'lucide-react';
...
const FTPManagementModal: React.FC<FTPManagementModalProps> = ({ account, onClose, onRefresh }) => {
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            alert('FTP account deleted successfully!');
            onRefresh();
            onClose();
        } catch (err: any) {
    ...
    return (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-xl z-[1100] flex items-center justify-center p-4">
            <div className="glass w-full max-w-3xl rounded-[32px] overflow-hidden border border-white/5 shadow-2xl animate-scale-up flex flex-col max-h-[90vh]">
                ...
                <div className="flex-1 overflow-y-auto p-8 custom-scrollbar bg-black/20">
                    ...
                    {activeTab === 'settings' && (
                        <form onSubmit={handleUpdate} className="space-y-6 animate-fade">
