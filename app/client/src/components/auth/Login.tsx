                    ...
                    <div className="relative z-10">
                        <div className="flex flex-col gap-4 mb-12">
                            ...
                            <div>
                                ...
                                <span className="text-[10px] font-black text-indigo-500/60 uppercase tracking-[0.2em]">Version {siteSettings?.panel_version}</span>
                            </div>
                        </div>
                            ...
                            >
                                <div className="mb-10 text-center md:text-left">
                                    ...
                                    <div className="md:hidden flex flex-col items-center gap-4 mb-8">
                                        ...
                                        <div>
                                            <h1 className="text-2xl font-black text-white tracking-widest uppercase mb-1">{siteSettings?.site_title || 'YUMNA PANEL'}</h1>
                                            <span className="text-[10px] font-black text-indigo-500/60 uppercase tracking-[0.2em] block text-center">Version {siteSettings?.panel_version}</span>
                                        </div>
                                    </div>
