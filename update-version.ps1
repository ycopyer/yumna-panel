...
if (Test-Path $clientPkgPath) {
    ...
    Write-Host "✅ Updated Client package.json" -ForegroundColor Green
}
...
if (Test-Path $serverPkgPath) {
    ...
    Write-Host "✅ Updated Server package.json" -ForegroundColor Green
}
...
if (Test-Path $websiteJsPath) {
    ...
    Write-Host "✅ Updated websites.js template" -ForegroundColor Green
}

Write-Host "`n🚀 Yumna Panel is now at v$NewVersion" -ForegroundColor Yellow
